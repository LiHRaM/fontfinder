...
impl Header {
    pub fn new() -> Header {
        ...
        let settings = cascade! {
            gtk::MenuButton::new();
            ..set_image(Some(&gtk::Image::new_from_icon_name(Some("preferences-system"), IconSize::Menu)));
